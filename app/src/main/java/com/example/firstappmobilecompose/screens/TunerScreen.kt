...
@Composable
fun TunerScreen(navController: NavController,tunerState: TunerState) {
    Scaffold(
        topBar = { TopAppBar_PageTuner2() },
        content = { BodyContent_PageTuner2(tunerState) },
        bottomBar = { BottomAppBar_PageTuner2(navController) }
    )
}

@Composable
fun TopAppBar_PageTuner2() {
...
@Composable
fun BottomAppBar_PageTuner2(navController: NavController) {
...
@Composable
fun BodyContent_PageTuner2(tunerState: TunerState){
    Column(
        modifier = Modifier
            .fillMaxSize()
